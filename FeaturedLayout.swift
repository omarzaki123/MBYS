...
//  Mesh
//
//  Created by Daniel Ssemanda on 9/4/16.
...
struct FeaturedLayoutConstants {
    struct Cell {
        ...
        static let standardHeight: CGFloat = 65
...
class FeaturedLayout: UICollectionViewLayout {
    ...
    override func prepareLayout() {
        ...
        for item in 0..<numberOfItems {
            ...
            if item == 0 {
                frame = CGRect(x: 0, y: y + 36, width: width, height: height)
            }else {
                frame = CGRect(x: 0, y: y + 5, width: width, height: height)
            }
    ...
    override func layoutAttributesForItemAtIndexPath(indexPath: NSIndexPath) -> UICollectionViewLayoutAttributes? {
        ...
        attribute = cache[indexPath.item]
        return attribute
    }
